                        ...
                        <div class="col-sm-15 col-6">
                            ...
                            @if ($item['stock'] == '0')
                                <input type="text" id="{{ $item['product_code'] }}" class="txtCal outofstock"
                                    name="{{ $item['product_code'] }}" value="" placeholder="Out of stock" readonly>
                            @else
                                <input type="text" id="{{ $item['product_code'] }}" class="txtCal"
                                    name="{{ $item['product_code'] }}" value="{{ old($item['product_code']) }}"
                                    placeholder="Enter the number">
                            @endif

                            <div class="caption1">PCS</div>
                            <input type="text" readonly style="border-width:1px" type="text"
                                class="border-top-0 border-right-0 border-left-0" name="{{ $groups[$x]['group'] . '[]' }}"
                                id="{{ $item['product_code'] . '-PCS' }}" value="" placeholder="">
                        </div>
