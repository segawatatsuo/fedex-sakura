...
--}}
                <select id="demo" >
                    <option value="" data-imgsrc="https://ccmedico.com/fedex/storage/img/cclogo.png" data-description=""></option>
                    <option value=""  data-imgsrc="https://ccmedico.com/fedex/storage/img/AIr_banner.png" data-description=""></option>
                   </select>
    ...
    <div class="container-fluid">
        <div class="container">
            ...
            <div class="articles">Air Stocking</div>
            <div class="articles"> <a href="{{ route('fedex',['article'=>'Nail']) }}">Nail</a> </div>
            <div class="articles">Other</div>
            </div>
        </div>
    </div>
