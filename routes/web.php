...
Route::middleware(['verified'])->group(function () {
    ...
    Route::get('fedex.nail', 'ProductController@fedex.nail')->name('fedex.nail');
    Route::get('air.nail', 'ProductController@air.nail')->name('air.nail');
    Route::get('ship.nail', 'ProductController@ship.nail')->name('ship.nail');
...
Route::resource('mail', 'EmailtextController');
Route::post('mailsend.send', 'MailSendController@send')->name('mailsend.send');