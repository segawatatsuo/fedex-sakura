    ...
    public function quotation(Request $request)
    {
      ...
      */
        ...
        */
        ...
        //単価を出す関数
        function which_tanka($hinban, $ctn, $fedex_low, $fedex_up, $air1_low, $air1_up, $air2_low, $air2_up, $ship_low, $ship_up)
        {
        ...
        foreach ($GOODS as $key => $val) {
            if ($val != "") {
                ...
                $tanka = which_tanka($hinban, $ctn, $fedex_low, $fedex_up, $air1_low, $air1_up, $air2_low, $air2_up, $ship_low, $ship_up);
